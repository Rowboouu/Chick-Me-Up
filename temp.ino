...
Code for ESP32 # 2 (Automation for Temperature System)

#define BLYNK_TEMPLATE_ID "TMPL6OAPaE7mU"
#define BLYNK_TEMPLATE_NAME "Soil Moisture Temperature and Humidity Monitor"
#define BLYNK_AUTH_TOKEN "LlGtXF8fpgjOEWVo75N9MjYT0fOlKR2S"
...
// Firebase ------------------------------------------------
#include <FirebaseESP32.h>
#define DATABASE_URL "https://temperature-ae783-default-rtdb.asia-southeast1.firebasedatabase.app/"
#define API_KEY "AIzaSyDHC960NvN6MEZXHbc25fc8_KMziWH_XHg"
#include "addons/TokenHelper.h"
#include "addons/RTDBHelper.h"
...
// Relay ---------------------------------------------------
#define fanRelay 32
#define lightRelay 33

// Max Temp for fan to activate ----------------------------
float tempMax = 35.0;
...
void sendSensor()
{
    ...
    if (Firebase.ready() && signupOK)
    {
        ...
        if (Firebase.setFloat(fbdo, path, t))
        {
            // Serial.println();
            // Serial.print(t);
